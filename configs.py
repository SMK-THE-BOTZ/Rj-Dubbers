...
STREAM_LOGS = environ.get('STREAM_LOGS','-1002057330647')
...
class Config(object):
	...
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5347496761"))
	...
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002051372834 -1002022033362")
