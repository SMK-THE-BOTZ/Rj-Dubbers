...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','https://missrozy-lbrs.onrender.com') else APP_NAME+'.herokuapp.com'
URL = "https://missrozy-lbrs.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://missrozy-lbrs.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://missrozy-lbrs.onrender.com/".format(FQDN)
else:
    URL = "https://missrozy-lbrs.onrender.com/".format(FQDN)
UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', None))
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "")).split())) 
STREAM_LOGS = environ.get('STREAM_LOGS','-1002085310062')
...
class Config(object):
	...
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002121351606))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "2058613983"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://smkthebotz:72gZn3mSwl2ttMrC@cluster0.k87k2x2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002022033362")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002085310062")
